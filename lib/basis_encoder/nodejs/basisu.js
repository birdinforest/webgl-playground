var basisu = (function() {
  ...
  return (
    function(basisu) {
      ...
      var Module = typeof basisu !== "undefined" ? basisu : {};
      var moduleOverrides = {};
      var key;
      for(key in Module) {
      ...
      var STACK_BASE = 630944, STACK_MAX = 5873824, DYNAMIC_BASE = 5873824, DYNAMICTOP_PTR = 630912;
      ...
      var wasmBinaryFile = "basisu.wasm";
      ...
      Module["asm"] = function(global, env, providedBuffer) {
        ...
        env["table"] = wasmTable = new WebAssembly.Table({"initial": 392, "maximum": 392, "element": "anyfunc"});
      ...
      if(!Object.getOwnPropertyDescriptor(Module, "writeStackCookie")) Module["writeStackCookie"] = function() {
        abort("'writeStackCookie' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)")
      };
      if(!Object.getOwnPropertyDescriptor(Module, "checkStackCookie")) Module["checkStackCookie"] = function() {
...
if(typeof exports === 'object' && typeof module === 'object')
  module.exports = basisu;
else if(typeof define === 'function' && define['amd'])
  define([], function() {
    return basisu;
  });
else if(typeof exports === 'object')
  exports["basisu"] = basisu;
